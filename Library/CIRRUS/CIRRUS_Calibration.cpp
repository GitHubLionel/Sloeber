...
void CIRRUS_Calibration::Complete(CIRRUS_Calib_typedef *Calib_base, float V1_Ref, float R)
{
	...
	WithCharge(Calib_base, V1_Ref, R);
}
 ...
 */
void CIRRUS_Calibration::WithCharge(CIRRUS_Calib_typedef *Calib_base, float V1_Ref, float R)
{
	...
	Current_Cirrus->do_gain_calibration(V1_Ref, R);
